...
STATIONS = [
    ...
    {"station": "Munich Hbf", "lat": 48.135, "lon": 11.582, "status": "Established", "city": "Munich", "state": "Bayern"},
    ...
    {"station": "Cologne Hbf", "lat": 50.943, "lon": 6.958, "status": "Established", "city": "Cologne", "state": "Nordrhein-Westfalen"},

    # Present (5 stations)
    {"station": "Stuttgart Hbf", "lat": 48.784, "lon": 9.177, "status": "Present", "city": "Stuttgart", "state": "Baden-Wurttemberg"},
    {"station": "Dusseldorf Hbf", "lat": 51.219, "lon": 6.794, "status": "Present", "city": "Dusseldorf", "state": "Nordrhein-Westfalen"},
    ...
    {"station": "Nuremberg Hbf", "lat": 49.446, "lon": 11.078, "status": "Expanding", "city": "Nuremberg", "state": "Bayern"},
...
def get_operator_history(customer_id):
    ...
    data = [
        ...
        {"project_id": "P003", "project_name": "Munich Hbf Installation", "start_date": "2024-06-20", "end_date": "2024-09-10", "status": "Completed", "psd_installed": 18, "project_value_eur": 180000, "completion_pct": 100},
        ...
        {"project_id": "P006", "project_name": "Cologne Hbf Planning", "start_date": "2025-03-01", "end_date": "2025-06-15", "status": "Planned", "psd_installed": 10, "project_value_eur": 100000, "completion_pct": 0},
    ]
...
def get_financial_projections(months_ahead=24, customer_id=None):
    """Return financial projections with realistic growth trajectory."""
    ...
    costs = (base_revenue * 0.6 * (1 + growth_rate * 0.8) ** np.arange(months_ahead)).astype(int)
    return pd.DataFrame({
        "Month": months.strftime("%Y-%m").tolist(),
        "Revenue": revenue.tolist(),
        "Customers": (np.linspace(15, 28, months_ahead, dtype=int) + np.random.randint(-1, 2, months_ahead)).clip(15, 30).tolist(),
        "Costs": costs.tolist(),
...
def get_operator_comparison_benchmarks(customer_id=None):
    ...
    return {
        ...
        "avg_response_hours": 3.5,
        "avg_psd_units": 25,
        "avg_contract_value": 250000,
        "percentiles": {"p25": 6.5, "p50": 7.8, "p75": 8.5, "psd_percentile": 75, "cost_percentile": 80, "satisfaction_percentile": 70},
        "tier_benchmarks": [
            {"tier": "Platinum", "avg_score": 9.0, "avg_value": 450000, "avg_psd": 40},
            {"tier": "Gold", "avg_score": 8.5, "avg_value": 300000, "avg_psd": 30},
            {"tier": "Silver", "avg_score": 7.5, "avg_value": 200000, "avg_psd": 20},
            {"tier": "Bronze", "avg_score": 6.5, "avg_value": 120000, "avg_psd": 10},
        ],
    }
